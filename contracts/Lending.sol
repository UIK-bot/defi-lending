...
contract Lending is ReentrancyGuard {
    ...
    function borrow(uint256 amount) public nonReentrant {
        ...
        require(_isHealthy(msg.sender, newDebt), "Insufficient collateral ratio");
    ...
    function withdraw(uint256 amount) public nonReentrant {
        ...
        if (positions[msg.sender].debt > 0) {
            uint256 newRatio = getCollateralRatio(msg.sender);
            require(newRatio >= MIN_COLLATERAL_RATIO, "Insufficient collateral ratio after withdrawal");
        }
